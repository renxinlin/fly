...
//24L01操作线   
#define Set_NRF24L01_CSN    (GPIOA->BSRR = GPIO_Pin_15) 	// PA15
#define Clr_NRF24L01_CSN	(GPIOA->BRR = GPIO_Pin_15)    	// PA15
#define Set_NRF24L01_CE 	(GPIOB->BSRR = GPIO_Pin_6)    		// PB6
#define Clr_NRF24L01_CE  	(GPIOB->BRR = GPIO_Pin_6)    		// PB6
#define READ_NRF24L01_IRQ   (GPIOB->IDR&GPIO_Pin_7)			//IRQ主机数据输入 PB7
